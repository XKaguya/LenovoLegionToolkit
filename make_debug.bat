...
dotnet publish LenovoLegionToolkit.WPF -c Debug -o BuildLLT /p:FileVersion=%VERSION% /p:Version=%VERSION% > build_debug.log 2>&1 || (type build_debug.log && exit /b)
dotnet publish LenovoLegionToolkit.SpectrumTester -c Debug -o BuildLLT /p:FileVersion=%VERSION% /p:Version=%VERSION% >> build_debug.log 2>&1 || (type build_debug.log && exit /b)
dotnet publish LenovoLegionToolkit.Probe -c Debug -o BuildLLT /p:FileVersion=%VERSION% /p:Version=%VERSION% >> build_debug.log 2>&1 || (type build_debug.log && exit /b)
dotnet publish LenovoLegionToolkit.CLI -c Debug -o BuildLLT /p:FileVersion=%VERSION% /p:Version=%VERSION% >> build_debug.log 2>&1 || (type build_debug.log && exit /b)
